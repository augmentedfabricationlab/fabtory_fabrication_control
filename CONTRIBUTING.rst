...
1. Fork `the repository <https://github.com/augmentedfabricationlab/customized_clt_alte_schmiede>`_ and clone the fork.
...
When `reporting a bug <https://github.com/augmentedfabricationlab/customized_clt_alte_schmiede/issues>`_
please include:
...
`Github <https://github.com/augmentedfabricationlab/customized_clt_alte_schmiede/issues>`_. If you are proposing a feature:
